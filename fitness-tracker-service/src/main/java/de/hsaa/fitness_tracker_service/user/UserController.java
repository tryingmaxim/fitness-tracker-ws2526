...
public class UserController {
	...
	public record RegisterRequest(@NotBlank String firstName, @NotBlank String lastName, @NotBlank @Email String email,
			@NotBlank String password, @NotNull @Min(12) Integer age, String gender) {
	}

	public record UpdateMeRequest(String firstName, String lastName, Integer age, String gender) {
	}

	public record UserResponse(Long id, String username, String email, String firstName, String lastName, Integer age,
			String gender) {
	}
	...
	private static UserResponse toDto(User u) {
		return new UserResponse(u.getId(), u.getUsername(), u.getUsername(), u.getFirstName(), u.getLastName(),
				u.getAge(), u.getGender());
	}
