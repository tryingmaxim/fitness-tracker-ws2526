...
public class ExerciseExecutionService {
	...
	public ExerciseExecution add(Long sessionId, Long exerciseId, Integer orderIndex, Integer plannedSets,
			Integer plannedReps, Double plannedWeightKg, String notes) {
	...
	public ExerciseExecution update(Long sessionId, Long id, Long exerciseId, Integer orderIndex, Integer plannedSets,
			Integer plannedReps, Double plannedWeightKg, String notes) {
